...
for (const banned of ['eval(', 'new Function', 'from"fs"', "from'fs'", 'node:fs', 'node:path']) {
  if (code.includes(banned)) {
    throw new Error(`browser bundle contains banned pattern: ${banned}`)
  }
}
